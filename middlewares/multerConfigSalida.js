...
//     const docPath = path.join('C:', 'xampp', 'htdocs', 'files_intranet', 'asistencia_salida', req.body.documento_colaborador);
...
//     const documentFolder = `asistencia_salida/${req.body.documento_colaborador}`;
//     const sanitizedFilename = sanitizeFilename(file.originalname); // Mantiene el nombre original sanitizado
