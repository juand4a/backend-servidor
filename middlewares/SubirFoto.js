...
//     const docPath = path.join('C:', 'xampp', 'htdocs', 'files_intranet', 'foto_perfil', req.body.documento);
...
//   },
//   contentType: multerS3.AUTO_CONTENT_TYPE, // Asegura que el Content-Type esté configurado automáticamente
//   key: function (req, file, cb) {
//     const documentFolder = `foto_perfil/${req.body.documento}`;
//     const sanitizedFilename = sanitizeFilename(file.originalname); // Mantiene el nombre original sanitizado
